...
<div id="empleado">
	...
	<div class="content-header">
		<div class="container-fluid">
		    <div class="row mb-2">
				<div class="col-sm-10">
				    <h1 class="m-0 text-dark">COLABORADORES DEL ÁREA DE ALIMENTOS Y BEBIDAS</h1>
				    <div class="image">
                ...
                <form action="">  
                  ...
                  <label>Departamento:</label>
	                <select class="form-control" v-model="departamento" required>
	                 	<option value="" disabled>Seleecione el área</option>
	                 	<option value="Alimentos y Bebidas">Alimentos y Bebidas</option>
	                </select><br>
                  <label>Puesto:</label>
	                <select class="form-control" v-model="puesto" required>
	                 	<option value="" disabled="">Seleccione el puesto</option>
	                 	<option value="Mesero">Hotel Reef | Alimentos y Bebidas | Mesero</option>
	                 	<option value="Cantinero">Hotel Reef | Alimentos y Bebidas | Cantinero</option>
	                 	<option value="Animador">Hotel Reef | Alimentos y Bebidas | Animador</option>
	                 	<option value="Steward">Hotel Reef | Alimentos y Bebidas | Steward</option>
	                 	<option value="Chef">Hotel Reef | Alimentos y Bebidas | Chef</option>
	                 	<option value="Ayudante de Cocina">Hotel Reef | Alimentos y Bebidas | Ayudante de Cocina</option>
	                 	<option value="Mayora">Hotel Reef | Alimentos y Bebidas | Mayora</option>
	                 	<option value="Repostero">Hotel Reef | Alimentos y Bebidas | Repostero</option>
	                 	<option value="DJ">Hotel Reef | Alimentos y Bebidas | DJ</option>
	                 	<option value="Cocinero">Hotel Reef | Alimentos y Bebidas | Cocinero</option>
	                </select><br>
...
@push('scripts')
<script type="text/javascript" src="js/apis/apiAlimento.js"></script>
@endpush
