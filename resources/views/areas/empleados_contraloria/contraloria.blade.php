...
<div id="empleado">
	...
	<div class="content-header">
	    <div class="container-fluid">
	        <div class="row mb-2">
		        <div class="col-sm-10">
	    	        <h1 class="m-0 text-dark">COLABORADORES DEL ÁREA DE CONTRALORÍA</h1>
		            <div class="image">
							...
							<table class="table table-hover text-nowrap table-bordered">
								...
								<tbody>
									<tr v-for="(empleado,index) in filtroEmpleados">
										...
										<td align="center">
											<button class="btn btn-sm" @click="editandoEmpleado(empleado.id_empleado)">
											...
											<!-- <button class="btn btn-sm" @click="eliminarEmpleado(empleado.id_empleado)">
              ...
              <form action="">            
                ...
                <select class="form-control" v-model="une" required>
                  ...
                  <option value="Hotel Reef">Hotel Reef</option>
	            	...
	            	<!-- <input type="text" class="form-control" v-model="une" placeholder="UNE" onkeypress="return soloLetras(event);"><br>  -->
                ...
                <label>Puesto:</label>
	                <!-- <input type="text" class="form-control" placeholder="Puesto" v-model="puesto"> -->
	            	<select class="form-control" v-model="puesto" required>
	                	<option value="" disabled="">Seleccione el puesto</option>
	                	<option value="Contador">Hotel Reef | Contraloría | Contador</option>
	                	<option value="Gerente General">Hotel Reef | Contraloría | Gerente General</option>
	                	<option value="Encargado de Deudas">Hotel Reef | Contraloría | Encargado de Deudas</option>
	                	<option value="Encargado de Administración de Propina">Hotel Reef | Contraloría | Encargado de Administración de Propinas</option>
	                	<option value="Compras">Hotel Reef | Contraloría | Compras</option>
	                	<option value="Caja General">Hotel Reef | Contraloría | Caja General</option>
	                	<option value="Auxiliar de Almacén">Hotel Reef | Contraloría | Auxiliar de Almacén</option>
	                	<option value="Encargado de Almacén">Hotel Reef | Contraloría | Encargado de Almacén</option>
	                	<option value="Agente de Seguridad">Hotel Reef | Contraloría | Agente de Seguridad</option>
	                	<option value="Chófer">Hotel Reef | Contraloría | Chófer</option>
	                	<option value="Chófer de Compras">Hotel Reef | Contraloría | Chófer de Compras</option>
	                	<option value="Encargado de Boutique">Hotel Reef | Contraloría | Encargado de Boutique</option>
	                	<option value="Encargado de Gestión de Talento Humano">Hotel Reef | Contraloría | Encargado de Gestión de Talento Humano</option>
		                <option value="Auxiliar de Gestión de Talento Humano">Hotel Reef | Contraloría | Auxiliar de Gestión de Talento Humano</option>
	            	</select><br>
...
@push('scripts')
<script type="text/javascript" src="js/apis/apiContraloria.js"></script>
@endpush
