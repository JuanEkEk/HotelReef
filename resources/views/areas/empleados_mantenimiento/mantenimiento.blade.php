...
<div id="empleado">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-10">
				    <h1 class="m-0 text-dark">COLABORADORES DEL ÁREA DE MANTENIMIENTO</h1>
				    <div class="image">
              ...
              <div class="modal-body"> 
                ...
                <label>Puesto:</label>
	            	<select class="form-control" v-model="puesto" required>
	              		...
	              		<option value="Jardinero">Hotel Reef | Mantenimiento | Jardinero</option>
	              		<option value="Alberquero">Hotel Reef | Mantenimiento | Alberquero</option>
	              		<option value="Electricista">Hotel Reef | Mantenimiento | Electricista</option>
	              		<option value="Albañil">Hotel Reef | Mantenimiento | Albañil</option>
	              		<option value="Mecánico de Cocina">Hotel Reef | Mantenimiento | Mecánico de Cocina</option>
	              		<option value="Pintor">Hotel Reef | Mantenimiento | Pintor</option>
	              		<option value="Encargado de Limpieza de Playas">Hotel Reef | Mantenimiento | Encargado de Limpieza de Playas</option>
	              		<option value="Técnico de Aires Acondicionados">Hotel Reef | Mantenimiento | Técnico de Aires Acondicionados</option>
	            	</select><br>
...
@push('scripts')
<script type="text/javascript" src="js/apis/apiMantenimiento.js"></script>
@endpush
