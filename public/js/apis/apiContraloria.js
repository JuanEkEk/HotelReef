...
var apiEmpleadoContraloria=ruta + '/apiEmpleadoContraloria';
var apiEmpleadoContraloriaDes = ruta + '/apiEmpleadoContraloriaDes';
...
new Vue({
    ...
    methods:{
        obtenerEmpleados:function(){
            this.$http.get(apiEmpleadoContraloria).then(function(json){
        ...
        obtenerEmpleadosDes:function(){
            this.$http.get(apiEmpleadoContraloriaDes).then(function(json){
        ...
        guardarEmpleado:function(){
            ...
            this.$http.post(apiEmpleadoContraloria,empleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
                this.id_empleado='';
                this.nombre='';
        ...
        eliminarEmpleado:function(id){
            ...
            if(confir)
            {
                this.$http.delete(apiEmpleadoContraloriaDes + '/' + id).then(function(json){
                    //this.obtenerEmpleados();
                    this.obtenerEmpleadosDes();
                }).catch(function(json){
                    console.log(json)
        ...
        editandoEmpleado:function(id){
            ...
            this.$http.get(apiEmpleadoContraloria + '/' + id).then(function(json){
        ...
        actualizarEmpleado:function(){
            ...
            this.$http.patch(apiEmpleadoContraloria + '/' + this.id_empleado,jsonEmpleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
    ...
    //                     empleado.nombre.toLowerCase().match(this.buscar.toLowerCase().trim());
    //         });
    //     }
    // }
