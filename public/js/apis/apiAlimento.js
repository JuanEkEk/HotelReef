...
var apiEmpleadoAlimento=ruta + '/apiEmpleadoAlimento';
var apiEmpleadoAlimentoDes = ruta + '/apiEmpleadoAlimentoDes';
...
new Vue({
    ...
    methods:{
        obtenerEmpleados:function(){
            this.$http.get(apiEmpleadoAlimento).then(function(json){
        ...
        obtenerEmpleadosDes:function(){
            this.$http.get(apiEmpleadoAlimentoDes).then(function(json){
        ...
        guardarEmpleado:function(){
            ...
            this.$http.post(apiEmpleadoAlimento,empleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
                this.id_empleado='';
                this.nombre='';
        ...
        eliminarEmpleado:function(id){
            ...
            if(confir)
            {
                this.$http.delete(apiEmpleadoAlimentoDes + '/' + id).then(function(json){
                    //this.obtenerEmpleados();
                    this.obtenerEmpleadosDes();
                }).catch(function(json){
                    console.log(json)
        ...
        editandoEmpleado:function(id){
            ...
            this.$http.get(apiEmpleadoAlimento + '/' + id).then(function(json){
        ...
        actualizarEmpleado:function(){
            ...
            this.$http.patch(apiEmpleadoAlimento + '/' + this.id_empleado,jsonEmpleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
