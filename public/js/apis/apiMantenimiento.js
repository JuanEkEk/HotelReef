...
var apiEmpleadoMantenimiento=ruta + '/apiEmpleadoMantenimiento';
var apiEmpleadoMantenimientoDes = ruta + '/apiEmpleadoMantenimientoDes';
...
new Vue({
    ...
    methods:{
        obtenerEmpleados:function(){
            this.$http.get(apiEmpleadoMantenimiento).then(function(json){
        ...
        obtenerEmpleadosDes:function(){
            this.$http.get(apiEmpleadoMantenimientoDes).then(function(json){
        ...
        guardarEmpleado:function(){
            ...
            this.$http.post(apiEmpleadoMantenimiento,empleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
                this.id_empleado='';
                this.nombre='';
        ...
        eliminarEmpleado:function(id){
            ...
            if(confir)
            {
                this.$http.delete(apiEmpleadoMantenimientoDes + '/' + id).then(function(json){
                    //this.obtenerEmpleados();
                    this.obtenerEmpleadosDes();
                }).catch(function(json){
                    console.log(json)
        ...
        editandoEmpleado:function(id){
            ...
            this.$http.get(apiEmpleadoMantenimiento + '/' + id).then(function(json){
        ...
        actualizarEmpleado:function(){
            ...
            this.$http.patch(apiEmpleadoMantenimiento + '/' + this.id_empleado,jsonEmpleado).then(function(json){
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
        ...
        actualizarDatosRestantes:function(){
            ...
            this.$http.patch(apiEmpleadoMantenimiento + '/' + this.id_empleado,jsonEmpleado).then(function(json){
                var confir= confirm('Los datos fueron se guardaron correctamente');
                this.obtenerEmpleados();
                this.obtenerEmpleadosDes();
            });
