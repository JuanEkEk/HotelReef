...
class MantenimientoDesactivadoController extends Controller
{
    /**
    ...
    {
        return $mantenimiento = FacadesDB::select('SELECT * FROM empleados WHERE departamento = "Mantenimiento" AND estado = "Baja"');
    }
