...
class ContraloriaDesactivadoController extends Controller
{
    /**
    ...
    {
        return $contraloria = FacadesDB::select('SELECT * FROM empleados WHERE departamento = "Contraloría" AND estado = "Baja"');
    }
