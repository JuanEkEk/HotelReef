...
class AlimentoDesactivadoController extends Controller
{
    /**
    ...
    {
        return $alimento = FacadesDB::select('SELECT * FROM empleados WHERE departamento="Alimentos y Bebidas" AND estado = "Baja"');
    }
